...
export const stageApi = {
  postStopAxis: (stageId: string, axis: string) =>
    api.post(`/${stageId}/stop_axis`, { logical_axis: axis }),

  postHomeAxis: (stageId: string, axis: string) =>
    api.post(`/${stageId}/home_axis`, { logical_axis: axis }),
  ...
  getVelocity: (stageId: string, axis: string): Promise<number> =>
    api
      .get<number>(`/${stageId}/velocity`, { params: { axis } })
      .then((res) => res.data),

  getMaxVelocity: (stageId: string, axis: string): Promise<number> =>
    api
      .get<number>(`/${stageId}/max_velocity`, { params: { axis } })
      .then((res) => res.data),

  getRange: (stageId: string, axis: string): Promise<[number, number]> =>
    api
      .get<[number, number]>(`/${stageId}/range`, { params: { axis } })
      .then((res) => res.data),
};
